...
const Aboutus = () => {
  ...
  return (
    ...
    <Modal className="customise" show={show} onHide={handleClose}  backdrop="static" keyboard={false} >
      ...
      <div class="row">
        <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
          <div class="inner-column">
            {/* <div class="sec-title">
              <span class="title">About KitaBook</span>
            </div> */}
            <div className="aboutflex">
              ...
              <div className="text">
                ...
                yourself in a passionate community. Join us on an extraordinary
                journey of self-expression and discovery, where storytelling,
                learning, and the joy of listening converge.
              </div>
